...
attn_group.add_argument("--use-flash-attention", action="store_true", help="Use FlashAttention 3.")
attn_group.add_argument("--use-flash-attention-4", action="store_true", help="Use FlashAttention 4.")
